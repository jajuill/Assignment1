...
//an expense object stores the total cost of each currency
//does not yet delete expense if cost == 0
...
public class Expenses {
	...
	public String getValue(){//returns value and currency to be outputted
